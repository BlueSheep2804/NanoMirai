...
class LabEffectRecipeBuilder(val mobEffectInstance: MobEffectInstance, val catalyst: Ingredient, val items: NonNullList<Ingredient>) : SimpleRecipeBuilder(
    ...
    override fun save(output: RecipeOutput, id: ResourceLocation) {
        ...
        val recipe = LabEffectRecipe(mobEffectInstance, catalyst, items)
        output.accept(
            recipeId,
            recipe,
